...
//                        }, 500);
    ...
    <jsp:body>
        ...
        <a href="jumpAddSubject.do" class="btn btn-sm btn-primary"><i class="ace-icon glyphicon glyphicon-plus"></i>
            新增学科
        </a>
        <div class="col-xs-12">
            <table id="simple-table" class="table  table-bordered table-hover">
                ...
                <c:forEach items="${subjects}" var="subject">
                    <tr>
                        ...
                        <td>
                            <a href="#">${subject.subId}</a>
                        </td>
                        <td>${subject.subName}</td>
                        <td class="hidden-480">${subject.students.size()}人</td>
                        <td>
                            <c:forEach items="${subject.students}" var="stud">
                            <c:forEach items="${sss}" var="ss">
                                <c:if test="${[subject.subId]==[ss.id.sub_Id]&&[stud.stuId]==[ss.id.stu_Id]}">
                                    <c:set var="sum" value="${sum+ss.score}"></c:set>
                        ...
                        <td>
                            <div class="hidden-sm hidden-xs btn-group">
                                <div class="hidden-sm hidden-xs btn-group">
                                    <a href="updateSubject.do?id=${subject.subId}">
                                    ...
                                    <a data-id="${subject.subId}"
                                       data-url="delSubject.do" class="red btn-delete-modal">
                                        <button class="btn btn-xs btn-info">
                                        ...
                                        <div class="profile-user-info profile-user-info-striped">
                                                ...
                                                <div class="profile-user-info profile-user-info-striped">
                                                    <div class="profile-info-row">
                                                        <div class="profile-info-name"> 姓名： ${stud.stuName} </div>
