            ...
            <div class="col-xs-12">
                ...
                <form action="addGrade.do" method="post" class="form-horizontal" role="form" onsubmit="return yanzheng()">
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-9">
                            <input name= "gName"  type="text" value="${grade.gId}" readonly="readonly" id="form-field-1" placeholder="班级名称" class="col-xs-10 col-sm-5" />
                        </div>
                    </div>
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-9">
                            <input name= "gName" type="text" value="${grade.gName}" id="form-field-1" placeholder="班级名称" class="col-xs-10 col-sm-5" />
                        </div>
                    </div>
