...
//                        }, 500);
    ...
    <jsp:body>
        ...
        <div class="row">
            <div class="col-xs-12">
                <!-- PAGE CONTENT BEGINS -->
                <form action="upSubject.do" method="post" class="form-horizontal" role="form" onsubmit="return yanzheng()">
                    <script type="application/javascript">
                    ...
                    <div class="form-group">
                        ...
                        <label class="col-sm-3 control-label no-padding-right" for="form-field-1"> 学科编号 </label>

                        <div class="col-sm-9">
                            <input name= "subId" value="${subject.subId}"readonly="readonly" type="text" id="form-field-1" placeholder="学科名称" class="col-xs-10 col-sm-5" />
                        </div>
                    </div>
                    <div class="form-group">
                        ...
                        <div class="col-sm-9">
                            <input name= "subName" value="${subject.subName}" type="text" id="form-field-1" placeholder="学科名称" class="col-xs-10 col-sm-5" />
                        </div>
                    </div>
