                    ...
                    <div class="col-xs-12 col-sm-3 center">
                        <div>
												<span class="profile-picture">
													<img id="avatar" height="180px" width="180px" class="editable img-responsive" alt="Logo"  src="${empty admin.logo?'assets/images/avatars/profile-pic.jpg':admin.logo}" />
												</span>
                    ...
                    <div class="col-xs-12">
                        ...
                        <form class="form-horizontal" role="form">
                            <div class="form-group">
                                ...
                                <div class="col-sm-9">
                                    <input name= "stuId" type="text" id="form-field-1" placeholder="学号" class="col-xs-10 col-sm-5" />
                                </div>
                            </div>
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-9">
                                    <input name="stuName" type="text" id="form-field-1" placeholder="姓名" class="col-xs-10 col-sm-5" />
                                </div>
                            </div>
                                    ...
                                    <div class="control-group">
                                        ...
                                        <div class="radio">
                                            <label class="checkbox-inline">
                                                <input name="form-field-radio" value="male" type="radio" class="ace" />
                                                <span class="lbl"> 男</span>
                                            </label>


                                            <label class="checkbox-inline">
                                                <input name="form-field-radio" value="female" type="radio" class="ace" />
                                        ...
                                        <div class="row">
                                            <div class="col-xs-8 col-sm-3">
                                                <div class="input-group">
                                                    <input name="stuBirthday" class="form-control date-picker" id="id-date-picker-1" type="text" data-date-format="dd-mm-yyyy" />
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-9">
                                    <select name="stuGrade" class="col-sm-3 control-label no-padding-right" id="form-field-select-3" data-placeholder="Choose a State...">
                                        <option value="sf">书法班</option>
                                        <option value="AL">语文班</option>
                                        <option value="AK">数学班</option>
                                        <option value="AZ">IT班</option>
                                </div>
                                </select>
