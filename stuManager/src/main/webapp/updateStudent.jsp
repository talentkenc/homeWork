...
<form action="updateStudentAction" method="post" onsubmit="return check()">
	<td colspan="2">学生编号：<input id="id"  type="text" name="id" value=<%=request.getParameter("updateid") %> readonly="readonly"/></td>
	<td></td>
	<tr>
